<?php 
	...
	//else case	 
	 ...
	 $query= "SELECT o.id, o.order_no,$statusflag u.first_name, DATE_FORMAT(o.created_date , ".SHORT_DATE_WITHTIME." ) as order_date,o.credit, o.created_by FROM `[x]order` o ,`[x]user` u,`[x]user_areas` ua, `[x]user_zones` uz  WHERE o.created_by = u.id AND o.created_by = ua.userID AND o.created_by = uz.userID" . $extra . " $statusCondition ORDER BY o.id desc";
