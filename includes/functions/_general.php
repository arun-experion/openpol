...
function getUserData($uid) {
	$q= Query("SELECT id, title, first_name, last_name, username, password, email, phone, mobile, address, zone_id, area_id, status, created_by, DATE_FORMAT(`created_date` , ".SHORT_DATE_WITHTIME." ) as created_date FROM `[x]user` WHERE id='{$uid}'");	 
