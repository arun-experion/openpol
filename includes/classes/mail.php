<?php
	...
	class SendMail {
		...
		var $SMTPPort = 587;	
		var $SMTPUser = "terumopenpol2021@gmail.com";						// SMTP Authentication username
		var $SMTPPassword = "terumo@2021";										// SMTP Authentication password
		var $SMTPTimeout = 	10;									// SMTP Timeout
		
		/* Advanced settings */
		var $MailMethod = 	"smtp";								// Sets the mailing method; mail, tinymail, smtp, sendmail
