                      ...
                      <td align="left" valign="middle" class="dlbox"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td width="587"><table width="100%" border="0" cellspacing="10" cellpadding="0">
                                <tr>
                                  <td width="12%" class="formtext">GST No :</td>
                          ...
                          <LOOP products>
                            <tr class="whitecolumnrow{class}">
                              ...
                              <td align="center" class="columnborder"><table width="69%" border="0" cellspacing="10" cellpadding="0">
								...
								<td align="center" class="columnborder"><table width="69%" border="0" cellspacing="10" cellpadding="0">
                                  <tr>
                                    <td class="blacktextnormal"><label>{delivery_date}</label></td>
                                  </tr>
                                </table></td>
                              <td class="columnborder"><table width="100%" border="0" cellspacing="10" cellpadding="0">
                                  <tr>
                ...
                <td><table width="100%" border="0" cellpadding="0" cellspacing="20" bgcolor="#DCE0EB">
                    <tr>
                      <td class="rowone"><table width="100%" border="0" cellspacing="5" cellpadding="0">
                          <tr>
                            <!-- <td align="center" class="formtext">Rate exclusive of ED and Tax against {form}</td>-->
                            <td align="center" class="formtext">Rate exclusive of GST</td>
                          </tr>
                        </table>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                  ...
                  <zone orderupdateform enabled>
                    <form action="vieworder.php" method="post" name="statuschangeform" id="statuschangeform">
                  ...
                  <zone updateorderstatus disabled>
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="formboot">
                      <tr>
                        <td><table width="100%" border="0" cellspacing="5" cellpadding="0">
                            <tr>
                              <td align="left"><zone cancelbutton enabled>
                                  <input name="button" type="button" class="formbutton" id="button6" value=" Cancel order " onclick="redirect('cancelorder.php?id={id}')" />
                                </zone cancelbutton enabled></td>
                              <td width="49%" align="right" valign="top"><input name="button" type="button" class="formbutton" id="button6" value=" Back to orders " onclick="redirect('list_orders.php')" /></td>
                            </tr>
                          </table></td>
                      </tr>
                    </table>
...
<!--<input type="hidden" name="modify_access" id="modify_access" value="{access}" />
