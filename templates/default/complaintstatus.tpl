                  ...
                  <td align="center"><table width="907" border="0" cellpadding="0" cellspacing="0" class="formborder">
                      <tr>
                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
                              <td valign="middle" class="formtitlebg">Complaint Status Configurations</td>
                            </tr>
                            <tr>
                              ...
                              <td align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr class="columnrow{class}">
                                    ...
                                    <td class="columnborder"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                                        <tr>
                                          <td class="formtext" align="center" ><a href="complaintstatus.php?id={id}"><img src="{theme}images/edit.png" alt="" width="26" height="26" border="0" /></a>  <a href="complaintstatus.php?delete={id}" class="deleteaction" style="text-decoration:none"><img src="{theme}images/close.png" alt="" width="26" height="26" border="0" /></a></td>
                                        </tr>
                                    </table></td>                                     
                                  </tr> 
                                    </LOOP workflows> 
